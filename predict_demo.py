...
CLASS_NAMES = ['class1', 'class2', 'class3']  # Will be loaded from model if available
...
def main():
    ...
    if args.classes:
        ...
        print("   To specify custom classes, use: --classes class1 class2 class3")
    
    # Load model
    try:
        model = load_model(args.model)
        model_display_name = "Custom CNN" if args.model == "custom_cnn" else "ResNet50 Transfer"
